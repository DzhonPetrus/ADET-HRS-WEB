                ...
                <div class="row justify-content-center text-center">
                    <div class="col-xl-9">
                        <div class="h1-slider-caption">
                            <h1 data-animation="fadeInDown" data-delay=".4s">top hotel in the city</h1>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="<?= base_url() ?>marian-master/assets/img/hero/h1_hero.jpg" >
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-xl-9">
                        <div class="h1-slider-caption">
        ...
        <div class="row">
           <div class="col-xl-5 col-lg-6">
                <div class="customer-img mb-120">
                    <img src="<?= base_url() ?>marian-master/assets/img/customer/customar1.png" class="customar-img1" alt="">
                    <img src="<?= base_url() ?>marian-master/assets/img/customer/customar2.png" class="customar-img2" alt="">
            ...
            <div class=" col-xl-4 col-lg-4">
                <div class="customer-caption">
                    ...
                    <div class="caption-details">
                        ...
                        <a href="about" class="btn more-btn1">Learn More <i class="ti-angle-right"></i> </a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6">
                ...
                <div class="single-room mb-50">
                    ...
                    <div class="room-caption">
                        <h3><a href="rooms.html">Standard</a></h3>
                        <div class="per-night">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                ...
                <div class="single-room mb-50">
                    ...
                    <div class="room-caption">
                        <h3><a href="rooms.html">Deluxe</a></h3>
                        <div class="per-night">
                            <span><u>₱</u>3000 <span>/ per night</span></span>
                            <h4> 1 to 4 Persons</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-6">
                ...
                <div class="single-room mb-50">
                    ...
                    <div class="room-caption">
                        <h3><a href="rooms.html">Super Suite</a></h3>
                        <div class="per-night">
                            <span><u>₱</u>4000 <span>/ per night</span></span>
                            <h4> 1 to 5 Persons</h4>
                        </div>
                    </div>
                </div>
            </div>
