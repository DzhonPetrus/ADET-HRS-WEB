    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <button type=button class=" btn btn-sm btn-neutral" data-toggle="modal" data-target="#FormTaxes" id="show_tax_form" onClick="newHandler()">Add Room</button>
        </div>
      </div>
    </div>
  </div>
          ...
          <table class="table align-items-center table-flush" style="width:100%" id="myTables">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="sort" data-sort="">Package ID</th>
                <th scope="col" class="sort" data-sort="">Min Guest</th>
                <th scope="col" class="sort" data-sort="">Max Guest</th>
                <th scope="col" class="sort" data-sort="">Price</th>
                <th scope="col" class="sort" data-sort="">Room Type </th>
                <th scope="col" class="sort" data-sort="">Created by </th>
              </tr>
            </thead>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="FormTaxesLabel">PACKAGES</h5>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group" id="group-percentage">
                    <label class="form-control-label" for="input-tax-percentage">Package ID</label>
                    <input type="Number" id="percentage" class="form-control">
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="form-group" id="group-percentage">
                    <label class="form-control-label" for="input-tax-percentage">Min Guest</label>
                    <input type="Number" id="percentage" class="form-control">
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="form-group" id="group-percentage">
                    <label class="form-control-label" for="input-tax-percentage">Max Guest</label>
                    <input type="Number" id="percentage" class="form-control">
                  </div>
                </div>
                <div class="col-lg-12">
...
<!-- Import JS-->
<script src="<?= base_url('assets') ?>/js/pages/rooms.js"></script>