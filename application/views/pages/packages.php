          ...
          <div class="card-body">
            ...
            <div class="pl-lg-4">
              <div class="row">
                ...
                <textarea id="description"  rows="3" placeholder="Room Description" class="form-control" name="description"></textarea>
                  </div>
                </div>
                <div class="col-lg-12">
...
<!-- Import JS-->
<script src="<?= base_url('assets') ?>/js/pages/packages.js"></script>